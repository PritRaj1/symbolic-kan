...
SYMBOLIC_LIB = Dict(
    ...
    "sqrt" => (x -> sqrt.(Complex(x)), x -> sympy.sqrt.(x), 2, f_sqrt),
    "x^0.5" => (x -> sqrt.(Complex(x)), x -> sympy.sqrt.(x), 2, f_sqrt),
    "x^1.5" => (x -> sqrt.(Complex(x)).^3, x -> sympy.sqrt.(x).^3, 4, f_power1d5),
    "1/sqrt(x)" => (x -> 1 ./ sqrt.(Complex(x)), x -> 1 ./ sympy.sqrt.(x), 2, f_invsqrt),
    "1/x^0.5" => (x -> 1 ./ sqrt.(Complex(x)), x -> 1 ./ sympy.sqrt.(x), 2, f_invsqrt),
